...
public enum CreatureStatistic implements CreatureStatisticIf
{
    ...
    WALKING_DEAD( "Walking Dead", 5, 5, 15, 3, Range.closed( 2, 3 ), 2,
        "Basically its the same skeleton with more hit points. I prefer buying 2 skeletons instead.", false,MovementType.WALKING ), //
    ...
    CreatureStatistic( final String aName, final int aAttack, final int aArmor, final int aMaxHp,
        ...
        final boolean aIsUpgraded,MovementType amovementType )
    {
        name = aName;
        attack = aAttack;
        armor = aArmor;
