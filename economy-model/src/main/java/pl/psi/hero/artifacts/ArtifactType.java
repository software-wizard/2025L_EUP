...
public enum ArtifactType {
    ...
    AXE_OF_SMASHING("Axe of Smashing", "/objects/Artifact_Axe_of_Smashing.gif", new Statistics(2, 0, 0, 0), 2000),
    ...
    FIZBIN_OF_MISFORTUNE("Fizbin of Misfortune", "/objects/Artifact_Fizbin_of_Misfortune.gif", new Statistics(0, 0, -2, -2), 1000),
    ...
    MYSTIC_ORB_OF_MANNA("Mystic Orb of Mana", "/objects/Artifact_Mystic_Orb_of_Manas.gif", new Statistics(0, 0, 0, 2), 4000),
    ORB_OF_SILT("Orb of Silt", "/objects/Artifact_Orb_of_Silt.gif", new Statistics(0, 0, 2, 0), 2000),
    PLATE_OF_DARKNESS("Plate of Darkness", "/objects/Artifact_Plate_of_Darkness.gif", new Statistics(0, 5, 0, 0), 4000),
    ...
    SWORD_OF_THE_GODS("Sword of the Gods", "/objects/Artifact_Sword_of_the_Gods.gif", new Statistics(6, 6, 6, 6), 25000),
    TITANS_CUIRASS("Titan's Cuirass", "/objects/Artifact_Titan's_Cuirass.gif", new Statistics(0, 0, 0, 10), 10000),
    TITANS_GLADIUS("Titan's Gladius", "/objects/Artifact_Titan's_Gladius.gif", new Statistics(12, 0, 0, 0), 10000),
    TITANS_THUNDER("Titan's Thunder", "/objects/Artifact_Titan's_Thunder.gif", new Statistics(9, 9, 9, 9), 60000),
