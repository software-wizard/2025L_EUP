...
// Fire Wall
    FIRE_WALL_SMALL(
            new Resources(200, 0, 0, 0, 0, 0, 0),
            () -> new FireWallSpell("Fire Wall Small", 1, new Point(2, 1), 4.0)
    ),

    FIRE_WALL_MEDIUM(
            new Resources(300, 0, 0, 0, 0, 0, 0),
            () -> new FireWallSpell("Fire Wall Medium", 2, new Point(3, 1), 6.0)
    ),

    FIRE_WALL_LARGE(
            new Resources(450, 0, 0, 0, 0, 0, 0),
            () -> new FireWallSpell("Fire Wall Large", 3, new Point(5, 1), 8.5)
    ),

    ADVANCED_FIRE_WALL(
            new Resources(600, 0, 0, 0, 0, 0, 0),
            () -> new FireWallSpell("Advanced Fire Wall", 4, new Point(7, 1), 11.0)
    );
