...
public enum ResourceGenType {
    ...
    GOLD("/objects/gold_mine.jpg", new Resources(0, 0, 0, 0, 0, 0, 1)),
    MERCURY("/objects/mercury_lab.jpg", new Resources(0, 0, 0, 0, 0, 0, 1)),
    ORE("/objects/ore_deposits.jpg", new Resources(0, 0, 0, 0, 0, 0, 1)),
    SULFUR("/objects/sulfur_mound.jpg", new Resources(0, 0, 0, 0, 0, 0, 1)),
    WOOD("/objects/sawmill.jpg", new Resources(0, 0, 0, 0, 0, 0, 1)),;
